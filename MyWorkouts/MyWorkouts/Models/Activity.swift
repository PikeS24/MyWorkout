...
@Model class Activity {
    ...
    init(name: String, icon: ActivitySymbol = .wave, hexColor: String = "FF0000") {
        self.name = name
    ...
    static var preview: ModelContainer {
        ...
        var sampleActivities: [Activity] {
            [
                ...
                Activity(name: "pres", icon: .walk, hexColor: "B33234"),
                Activity(name: "not", icon: .wave, hexColor: "B33234"),
