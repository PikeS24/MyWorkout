    ...
    var body: some View {
        ...
        Group {
            if activity.workouts.isEmpty{
                ContentUnavailableView("Create your first \(activity.name) work by tapping on the \(Image(systemName: "plus.circle.fill")) button at the top.", systemImage: "\(activity.icon)")
            } else {
